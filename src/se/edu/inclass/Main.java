...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (Task t: filteredByString(tasksData, "11")) {
    ...
    public static int countDeadlinesUsingStreams(ArrayList<Task> tasksData) {
        System.out.println("Calculaing count using streams");
        int count;
    ...
    public static ArrayList<Task> filteredByString(ArrayList<Task> tasksData, String filterString) {
